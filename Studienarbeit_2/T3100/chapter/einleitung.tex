...
Die Entwicklung des Roboters gliedert sich in drei thematische Schwerpunkte. Das erste Kapitel behandelt die technische Weiterentwicklung des Roboters. Hier werden die mechanischen und elektronischen Konzepte entwickelt, anhand von Trade-off-Analysen bewertet und anschließend praktisch umgesetzt. Im zweiten Schwerpunkt stehen das Design sowie die Verkleidung des Roboters im Vordergrund. Dabei werden die Entwicklung des äußeren Erscheinungsbildes, die Konstruktion der Bauteile sowie deren Fertigung beschrieben. Das dritte Kapitel widmet sich den Interaktionsfunktionen des Roboters. Hierzu zählen insbesondere die Entwicklung und Integration der Sprachinteraktion sowie weiterer Funktionen zur Mensch-Roboter-Interaktion.
