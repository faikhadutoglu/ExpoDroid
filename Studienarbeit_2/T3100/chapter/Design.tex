...
Die Armverkleidung von der Abbildung \ref{fig:DEArm1} wird in zwei getrennte Teile unterteilt (siehe Abbildung \ref{fig:DEArm2}), um die gesamte Kabeldurchführung deutlich zu vereinfachen. Statt eine einzige geschlossene Hülle zu haben, die das Verlegen der Leitungen erschwert, erlaubt die Zweiteilung, dass Kabel von Motor und Elektronik sauber eingeführt, geführt und später gewartet werden können.
