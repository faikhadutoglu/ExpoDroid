...
Fahrgeschwindigkeit nicht mehr beeinträchtigt\footnote{Die neuen Bremswerte wurden für einen Bereich von 40–50 cm definiert, anstatt für den ursprünglich geplanten Bereich von 0–100 cm.}. Alternativ bietet sich an,
die Sensoren entweder höher zu montieren oder leicht nach oben geneigt
auszurichten, um den Boden aus dem Erfassungsbereich auszuschließen. Dafür ist eine Überarbeitung der 3D-Konstruktion für die Ultraschallgehäuse erforderlich.
