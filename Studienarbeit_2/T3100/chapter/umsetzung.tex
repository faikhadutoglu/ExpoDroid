...
% --- FAIK ---
\section{Antriebsregelung: Programmierung und Fahranalyse (Faik)}
\subsection{Umsetzung: Motorsteuerung und Sicherheit}
\subsubsection{Implementierung der Sensorfusion und Notstopp-Logik}
Coding der 3-Zonen-Logik.
\subsubsection{Antriebssteuerung (Exponentialfilter, Limits)}
Code-Implementierung der Rampen und Geschwindigkeitsbegrenzungen.

\subsection{Ergebnisse: Fahrverhalten und Regelgüte}
\subsubsection{Sicherheitsanalyse (Bremswege)}
Messung: Wie schnell stoppt der Roboter bei Hindernissen? Anforderungen checken!
\subsubsection{Analyse der Fahrdynamik: Geschwindigkeitsbegrenzung Exponentialfilter}
Vergleich des Anfahrverhaltens mit und ohne Filter. Anforderungen checken!