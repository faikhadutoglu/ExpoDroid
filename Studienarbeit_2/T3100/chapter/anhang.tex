...
\begin{table}[hbt]	
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{0.3\linewidth} >{\raggedright\arraybackslash}p{0.65\linewidth}}
		...
		\vspace{-\topsep}
		\begin{itemize}[noitemsep,topsep=0pt,partopsep=0pt,parsep=0pt]
			\item In Visual Studio Code integriert zur automatischen Generierung von Codevorschlägen, zur Unterstützung bei Fehlerbehebungen, Formulierungs- und Rechtschreibhilfe, wissenschaftliche Umformulierung
		\end{itemize} \\
		Gemini &
		\vspace{-\topsep}
		\begin{itemize}[noitemsep,topsep=0pt,partopsep=0pt,parsep=0pt]
...
%
\begin{longtable}{>{\raggedright\arraybackslash}p{0.7\linewidth} >{\raggedright\arraybackslash}p{0.25\linewidth}}
	\captionabove[Autorenverzeichnis]{Autorenverzeichnis der Kapitelzuordnung} \label{tab:autorenverzeichnis}\\
	\hline
	...
	\hline
	\endlastfoot
	\ref{cha:Einleitung} \nameref{cha:Einleitung} & Angus Bach \\
	\ref{sec:Roboterarten} \nameref{sec:Roboterarten} & Angus Bach \\
	\ref{sec:Konstruktionsprinzipien} \nameref{sec:Konstruktionsprinzipien} & Angus Bach \\
	\ref{sec:Softwarelösungen} \nameref{sec:Softwarelösungen} & Simon Steiger \\
	\ref{sec:Elektromechanische} \nameref{sec:Elektromechanische} & Hai Nam Nguyen \\
	\ref{sec:KI} \nameref{sec:KI} & Simon Steiger \\
	\ref{cha:Vorgehensweise} \nameref{cha:Vorgehensweise} & Angus Bach \\
	\ref{cha:Design} \nameref{cha:Design} & Hai Nam Nguyen \\
	\ref{sec:Realisierung} \nameref{sec:Realisierung} & Angus Bach \\
	\ref{sec:KI-Systeme} \nameref{sec:KI-Systeme} & Simon Steiger \\
	\ref{cha:Bedienungsanleitung} \nameref{cha:Bedienungsanleitung} & Simon Steiger \\
	\ref{cha:Erkenntnisse} \nameref{cha:Erkenntnisse} & Angus Bach \\
	\ref{cha:Zusammenfassung} \nameref{cha:Zusammenfassung} & Angus Bach \\
	% Weitere Kapitel falls nötig...
\end{longtable}
