...
\begin{table}[hbt]	
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{0.3\linewidth} >{\raggedright\arraybackslash}p{0.65\linewidth}}
		...
		\vspace{-\topsep}
		\begin{itemize}[noitemsep,topsep=0pt,partopsep=0pt,parsep=0pt]
			\item In Visual Studio Code integriert zur automatischen Generierung von Codevorschlägen, zur Unterstützung bei Fehlerbehebungen, Formulierungs- und Rechtschreibhilfe
		\end{itemize} \\
		Gemini &
		\vspace{-\topsep}
		\begin{itemize}[noitemsep,topsep=0pt,partopsep=0pt,parsep=0pt]
