\begin{tikzpicture}[thick]
			...
			\coordinate (A) at (0,0);
			\coordinate (B) at (4,0);
			\coordinate (C) at (2,{2*sqrt(3)-1.25});
...
%		\node[right] at (3,1.7) {$a$};
			...
			Einzelnes Rad
			\draw[rounded corners,fill=black]
			(2-0.2,2+0.45) rectangle (2+0.2,2-0.45);
			\draw[line width=2] (2-0.4,2) -- ++ (+0.8,0);
			
			\node[align=center]  at (2,-1.5) {Ursprüngliches\\Fahrwerk};
		\end{scope}
		...
		\coordinate (A) at (0,0);
		\coordinate (B) at (4,0);
		\coordinate (C) at (2,{2*sqrt(3)-0.2});
...
%		\node[right] at (3,1.7) {$a$};
		...
		%Einzelnes Rad
						\draw[rounded corners,fill=black]
						(2-0.2,3+0.45) rectangle (2+0.2,3-0.45);
						\draw[line width=2] (2-0.4,3) -- ++ (+0.8,0);
						
			\node[align=center] at (2,-1.5) {Überarbeitetes\\Fahrwerk};
			
			\draw (3.75+0.4,0) -- ++ (0.7,0.5)  -- ++ (0.3,0) node[right] {Rad};
			\draw (3.75,3.1) -- ++ (0.7,0.5) -- ++ (0.3,0)
			node[right, align=left] {Karoserie\\Roboter};
			\draw (3.33,1.15) -- ++ (0.7,0.5)  -- ++ (0.3,0) node[right, align=left] {Stützpolygon};
		\end{scope}
