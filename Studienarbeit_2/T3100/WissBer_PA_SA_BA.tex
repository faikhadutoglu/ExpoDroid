...
\newcommand{\titel}{Weiterentwicklung eines Roboters für Messezwecke}
\newcommand{\untertitel}{}	% ggf. Untertitel mit ergänzenden Hinweisen
\newcommand{\arbeit}{Studienarbeit T3\lowrule 3200}
\newcommand{\studiengang}{Elektrotechnik}
\newcommand{\studienrichtung}{Fahrzeugelektronik}
\newcommand{\studienschwerpunkt}{}
\newcommand{\autor}{Angus Bach, Simon Steiger, 
	Hai Nam Nguyen}
\newcommand{\bearbeitungszeitraum}{15.01.2026 - 13.07.2026}
\newcommand{\matrikelnr}{1124670, 3007262, 9076280}
\newcommand{\kurs}{TFE23-2}
\newcommand{\firma}{Opel Automobile GmbH}
\newcommand{\abgabedatum}{\today}
\newcommand{\betreuerfirma}{Maximilian Wendt}
...
\usepackage{float}
\usepackage{booktabs} %faik hats hinzugefügt
%\usepackage{hyperref}
\usepackage{pgfgantt} % Gantt Diagramm
...
\usepackage{xcolor}
\usepackage{siunitx}
\sisetup{locale = DE} % Deutsche Zahlenschreibweise (Komma statt Punkt)
...
\addbibresource{literature/literatur3.bib}
\addbibresource{literature/literatur4.bib}
\addbibresource{literature/literaturhainam.bib}
\addbibresource{literature/literaturangus.bib}
\addbibresource{literature/literatursimon.bib}
...
%Motorcode styling (Faik)
\definecolor{motorBack}{rgb}{0.95,0.95,0.92} 
\definecolor{motorGreen}{rgb}{0,0.6,0}
\definecolor{motorPurple}{rgb}{0.58,0,0.82}

\lstdefinestyle{motorStyle}{
	backgroundcolor=\color{motorBack},   
	commentstyle=\color{motorGreen},
	keywordstyle=\color{magenta},     
	numberstyle=\tiny\color{gray},
	stringstyle=\color{motorPurple},
...
\usepackage{textcomp,xspace} % \textregistered, \texttrademark
...
\include{chapter/Ergebnisse Vorrangegenagener Arbeiten}
\include{chapter/vorgehen}
\include{chapter/Design}
\include{chapter/umsetzung}
\include{chapter/Testlauf im Messebetrieb}
...
%\setlength{\parskip}{0.5\baselineskip} %Ich habs auskommentiert (Faik)
\setlength{\parindent}{0ex} 	% bei neuem Abschnitt nicht einrücken
...
\include{chapter/Requierments_Tabelle}
\ifthenelse{\boolean{@twoside}}{%
	\cleardoubleoddpage
}{%
	%something false
