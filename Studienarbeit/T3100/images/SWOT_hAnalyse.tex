...
\begin{tikzpicture}[font=\sffamily]
	...
	{• Fachliche Expertise in Elektrotechnik und Informatik\\• Anerkannter Hochschulstatus\\• Praxisnahe Projekte eingebunden\\• Zugang zu technischer Infrastruktur\\• Kostenkalkulation im Budget};
	%{• Punkt 1\\• Punkt 2\\• Punkt 3};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H-1.2)
	{• Hoher organisatorischer Aufwand für Planung und Transport\\• Fehlende Praxiserfahrung Projektteam\\• Budget nicht einhaltbar\\• Risiko von Zeitverzögerungen durch parallele Lehrverpflichtungen}; % \\• Begrenzter finanzieller Spielraum
	
	\node[anchor=north west, align=left, text width=6.3cm] at (0.3,\H/2-1.2)
	{• Gewinnung neuer Studierender und Partnerunternehmen\\• Innovative Darstellung der Hochschule\\• Nutzung für Pressearbeit und Social Media};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H/2-1.2)
	{\\• Hohe Kosten ohne garantierten messbaren Nutzen\\• Konkurrenz durch ähnlichen Projekten\\• Technische Ausfälle erzeugen negatives Bild\\• Geringe Reaktionen der Zielgruppen};
\end{tikzpicture}
