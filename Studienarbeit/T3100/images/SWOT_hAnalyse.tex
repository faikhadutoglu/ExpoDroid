...
\begin{tikzpicture}[font=\sffamily]
	...
	{• Fachliche Expertise in Elektrotechnik und Informatik\\• Anerkannter Hochschulstatus\\• Praxisnahe Projekte eingebunden\\• Zugang zu technischer Infrastruktur};
	%{• Punkt 1\\• Punkt 2\\• Punkt 3};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H-1.2)
	{• Hoher organisatorischer Aufwand für Planung und Transport\\• Fehlende Praxiserfahrung\\• Mangel an finanzieller Unterstützung\\• Risiko von Zeitverzögerungen durch parallele Lehrverpflichtungen};
