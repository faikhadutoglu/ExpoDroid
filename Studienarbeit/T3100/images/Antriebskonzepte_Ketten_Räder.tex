...
%	 \draw (0,0) rectangle (5,5);
	...
	\node at (2.5,5.5) {I. Kettenantrieb};
	\node at (7.5,5.5) {II. Räder Allradantrieb};
	\node at (12.5,5.5) {III. Hinter-/Vorderantrieb};
	\node at (2.5,0.5) {IV. Diagonalangetrieben};
	\node[align=center] at (7.5,0.5) {V. Hinterradantrieb \& \\ zwei Räder freibeweglich};
	\node[align=center] at (12.5,0.5) {VI. Hinterradantrieb \& \\ ein Rad freibeweglich};
		\end{tikzpicture}