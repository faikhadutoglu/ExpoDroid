...
\begin{tikzpicture}[font=\sffamily]
	...
	{• Vorhandenes Fachwissen\\• Modularer Aufbau für Erweiterungen\\• Für Einsatz auf Messen spezialisiert\\• Softwarebasierte Funktionen (niedriger technischer Aufwand)};
	%{• Punkt 1\\• Punkt 2\\• Punkt 3\\• Punkt 3\\• Punkt 3};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H-1.2)
	{• Unebenes Gelände\\• Hoher Zeitaufwand für Entwicklung\\• Abhängigkeit von Drittanbieter-Komponenten\\• Eingeschränkte Robustheit};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (0.3,\H/2-1.2)
	{• Erhebung der Kenntnisse für nächste Generation Messeroboter\\• Möglichkeit zur Präsentation innovativer Technologien\\• Zukünftige Kooperationen\\• Einstieg in Messevermarktung der Zukunft};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H/2-1.2)
	{• Beschädigung empfindlichen LiPo-Akkus\\• Unfallrisiken während des Betriebs\\• Potentielle Wartungsanforderungen\\• Unvorhersehbare Betriebsumgebung};
\end{tikzpicture}
