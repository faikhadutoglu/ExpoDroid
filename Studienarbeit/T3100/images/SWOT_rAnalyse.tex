...
\begin{tikzpicture}[font=\sffamily]
	...
	{• Messebetrieb optimierte Bauweise\\• Modularer erweiterbare Aufbau\\• Softwarebasierte Funktionen (niedriger technischer Aufwand)\\• Gute Wendigkeit und kontrollierbares Fahrverhalten\\• Kompakte Bauform};
	%{• Punkt 1\\• Punkt 2\\• Punkt 3\\• Punkt 3\\• Punkt 3};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H-1.2)
	{• Unebenes Gelände Eingeschränkt\\• Hoher Zeitaufwand Entwicklung\\• Abhängigkeit von Drittanbieter-Komponenten\\• Eingeschränkte mechanische Robustheit\\• Begrenzte Akkulaufzeit};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (0.3,\H/2-1.2)
	{• Erhebung der Kenntnisse für nächste Generation Messeroboter
		%\\• Möglichkeit zur Präsentation innovativer Technologien
		\\• Wiederverwendbarkeit für weitere studentische Projekte\\• Anpassung an unterschiedliche Messeformate};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H/2-1.2)
	{• Beschädigung empfindlicher Komponenten (z. B. LiPo-Akku)\\• Unfallrisiken im Messeumgebungen\\• Potentieller Wartungsbedarf\\• Technische Ausfälle bei öffentlicher Vorführungen};
\end{tikzpicture}
