...
\begin{tikzpicture}[font=\sffamily]
	...
	{• Vorhandenes Fachwissen\\• Modularer Aufbau für Erweiterungen\\• Softwarebasierte Funktionen (niedriger technischer Aufwand)};
	%{• Punkt 1\\• Punkt 2\\• Punkt 3\\• Punkt 3\\• Punkt 3};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H-1.2)
	{• Fehlende Praxiserfahrung\\• Fehlende Ressourcen\\• Hoher Zeitaufwand für Entwicklung\\• Abhängigkeit von Drittanbieter-Komponenten\\• Eingeschränkte Robustheit};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (0.3,\H/2-1.2)
	{• Erhebung der Kenntnisse für nächste Generation Messeroboter\\• Möglichkeit zur Präsentation innovativer Technologien\\• Zukünftige Kooperationen\\• Anpassung für anderen Messen};
	
	\node[anchor=north west, align=left, text width=6.3cm] at (\W/2+0.3,\H/2-1.2)
	{• Unebenes Gelände\\• Riskante Umgebung während des Betriebs\\• Unfallrisiken während des Betriebs\\• Hohe Wartungsanforderungen};
\end{tikzpicture}
