...
\begin{longtable}{|p{1.7cm}|p{4.2cm}|p{8.8cm}|p{1.9cm}|}
	...
	\hline
	REQ-001 & Lenkung & Der Roboter muss in Fahrtrichtung lenken und Kurven fahren können (links/rechts). & High \\
	\hline
	REQ-003 & Drehen & Der Roboter muss gleichmäßig nach links und rechts drehen können. & Medium \\
	\hline
	REQ-004 & Rotation & Der Roboter muss sich auf der Stelle um die eigene Achse drehen können. & High \\
	\hline
	REQ-005 & Fahrprofil & Der Roboter muss sanft beschleunigen und verlangsamen (ruckfreier Übergang). & Medium \\
	\hline
	REQ-006 & Fernsteuerung & Der Roboter muss über eine Fernsteuerung (z.\,B. ESP32 + Fernbedienung oder App) steuerbar sein. & High \\
	\hline
	REQ-007 & Anzeige & Das Display muss Statusinformationen (z.\,B. Akkustand und Verbindungsstatus) anzeigen können. & Medium \\
	\hline
	REQ-008 & Sensorik/Kamera & Eine Kamera muss Bilddaten für einen Mikrocomputer bereitstellen können. & Medium \\
	\hline
	REQ-009 & Rechnerfunktionen & Ein Microcontroller muss Display und Audio ansteuern sowie KI-Funktionen ausführen können. & Medium \\
	\hline
	REQ-010 & Kopfbewegung & Der Kopf muss sich horizontal drehen können. & High \\
	\hline
	REQ-011 & Kopfbewegung & Der Kopf muss sich vertikal drehen können. & Low \\
	\hline
	REQ-012 & Kopfbewegung & Der Kopf muss sich um mindestens 180\textdegree{} drehen können. & Medium \\
	\hline
	...
	\hline
	REQ-102 & Nutzlast & Der Roboter muss mindestens 7\,kg Gesamtmasse (inkl.\ Eigengewicht) sicher bewegen können. & High \\
	\hline
	REQ-103 & Maximalgeschwindigkeit & Die maximale technische Geschwindigkeit darf 10\,km/h nicht überschreiten. & Medium \\
	\hline
	REQ-104 & Reichweite & Die Fernsteuerung muss in einer Entfernung von mindestens 10\,m zuverlässig funktionieren. & Low \\
	\hline
	REQ-105 & Positionsgenauigkeit & Servomotoren müssen eine Positionsgenauigkeit von \(\pm 2\textdegree\) erreichen. & High \\
	\hline
	...
	\hline
	REQ-202 & Messebetrieb & Im Messebetrieb muss die Geschwindigkeit softwareseitig auf maximal 5\,km/h begrenzt werden. & High \\
	\hline
	REQ-203 & Hinderniserkennung & Der Roboter soll bei Hindernissen automatisch anhalten. & Low \\
	\hline
	REQ-204 & Zugriffsschutz & Die innere Elektronik muss vor unbefugtem Zugriff geschützt sein. & Medium \\
	\hline
	REQ-205 & Erschütterungsschutz & Erschütterungen dürfen keine Beschädigungen an Elektronik oder Verdrahtung verursachen. & Medium \\
	\hline
	...
	\hline
	REQ-302 & Überlastschutz & Die Elektronik darf bei hoher Belastung nicht ausfallen oder beschädigt werden. & High \\
	\hline
	REQ-303 & Dynamikfestigkeit & Die Struktur muss plötzliche Kräfte- und Geschwindigkeitsänderungen aushalten können. & High \\
	\hline
	REQ-304 & Drehmoment & Der Antrieb muss über ausreichendes Drehmoment verfügen, um den Roboter sicher fortzubewegen. & High \\
	\hline
	...
	\hline
	REQ-402 & Akkuwechsel & Der Akku muss sicher und werkzeugarm wechselbar sein. & High \\
	\hline
	REQ-403 & Schutz & Beim Akkuwechsel darf die Elektronik nicht beschädigt werden können. & Medium \\
	\hline
	REQ-404 & Umweltschutz & Die innere Elektronik muss vor Schmutz und Umwelteinflüssen geschützt sein. & Medium \\
	\hline
	REQ-405 & Verschleiß & Der Antrieb darf keinen hohen Verschleiß aufweisen. & Medium \\
	\hline
...
%	\hline
	REQ-502 & Animation & Das Display soll animierte Augenbewegungen darstellen. & Low \\
	\hline
