...
\begin{table}[h]
	...
	\begin{tabular}{p{10cm} l}
		...
		\hyperref[cha:Display-Programmierung]{4.3. Display-Programmierung} & Vorname Nachname \\
		
		\hyperref[cha:Animations-Engine für Augen]{4.3.1. Animations-Engine für Augen} & Vorname Nachname \\
		
		\hyperref[cha:Benutzerschnittstelle]{4.3.2. Benutzerschnittstelle} & Vorname Nachname \\
		...
		\hyperref[cha:Integration]{4.4.4. Integration} & Vorname Nachname \\
		
		\hyperref[cha:Testumgebung und Aufbau]{4.4.5. Testumgebung und Aufbau} & Vorname Nachname \\
		
		\hyperref[cha:Testfälle und Akzeptanzkriterien]{4.4.6. Testfälle und Akzeptanzkriterien} & Vorname Nachname \\
		
		\hyperref[cha:Beobachtungen und Probleme]{4.4.7. Beobachtungen und Probleme} & Vorname Nachname \\
		
		\hyperref[cha:Geplante Netzwerktests (SSH/VNC)]{4.4.8. Geplante Netzwerktests (SSH/VNC)} & Vorname Nachname \\
		
		\hyperref[cha:Fehleranalyse und Optimierung]{4.4.9. Fehleranalyse und Optimierung} & Vorname Nachname \\
		...
		\hyperref[cha:Antrieb und Fahrverhalten]{5.1.1. Antrieb und Fahrverhalten} & Vorname Nachname \\
		
		\hyperref[cha:Interaktion und Aktorik]{5.1.2. Interaktion und Aktorik} & Vorname Nachname \\
		
		\hyperref[cha:Systemintegration]{5.1.3. Systemintegration} & Vorname Nachname \\
		...
		\hyperref[cha:Kritische Reflexion]{5.4. Kritische Reflexion} & Vorname Nachname \\
