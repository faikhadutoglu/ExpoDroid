...
\begin{table}[h]
	...
	\begin{tabular}{p{10cm} l}
		...
		%\hyperref[cha:Projekt und Systems Engineering Methodik]{2.8. Projekt \& Systems Engineering Methodik} 
		& Vorname Nachname \\
...
\begin{table}[h]
	...
	\begin{tabular}{p{10cm} l}
		...
		\hyperref[cha:Anforderungsanalyse]{3.2. Anforderungsanalyse} & Vorname Nachname \\
		...
		\hyperref[cha:Benutzerinteraktion]{3.5.3. Benutzerinteraktion} & Vorname Nachname \\
		...
		\hyperref[cha:Elektronische Architektur]{3.6.2. Elektronische Architektur} & Vorname Nachname \\
		...
		\hyperref[cha:Bewertung des Projekts aus Hochschulsicht]{3.9. Bewertung des Projekts aus Hochschulsicht} & Hai Nam Nguyen \\
		
		\hyperref[cha:SWOT-Analyse des Messeroboters]{3.9.1. SWOT-Analyse des Messeroboters} & Hai Nam Nguyen \\
