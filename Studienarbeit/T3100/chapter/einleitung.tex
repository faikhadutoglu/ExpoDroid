...
%
%\section{Aufgabenstellung\textcolor{brown}{FAIK}}
%%faik
...
%
%
%\section{Anforderungen an den Demonstrator(lieber weglassen?)\textcolor{brown}{FAIK}}
%%faik
...
%
%\section{Aufbau der Arbeit\textcolor{brown}{FAIK}}
%%faik
...
Ziel der Arbeit ist die Konzeption und Realisierung eines funktionsfähigen Demonstrators, der grundlegende Bewegungs- und Interaktionsfunktionen ausführt und als Präsentationsmedium dient. Der Roboter soll Aufmerksamkeit erzeugen, einen positiven Eindruck der Hochschule vermitteln und zugleich als technische Demonstrationsplattform genutzt werden können. Dabei stehen eine modulare Systemarchitektur, eine zuverlässige Funktion sowie eine sichere und wartungsfreundliche Auslegung im Vordergrund.

Zur Umsetzung dieses Ziels werden zunächst die Anforderungen an das System analysiert und strukturiert. Aufbauend darauf erfolgt die Entwicklung eines geeigneten Gesamtkonzepts, die Auswahl der erforderlichen Komponenten sowie die schrittweise Umsetzung der mechanischen, elektrischen und softwareseitigen Teilsysteme. Die Entwicklung orientiert sich dabei an einem systematischen Vorgehen mit modularer Strukturierung, Integration und begleitenden Tests.

Die Arbeit ist wie folgt aufgebaut: Nach der Einleitung werden die methodischen Grundlagen, insbesondere das verwendete Vorgehensmodell und das Anforderungsmanagement, vorgestellt. Anschließend folgt die Konzeption des Roboters, einschließlich Design- und Antriebsentscheidungen. Die darauffolgenden Kapitel befassen sich mit der Umsetzung, der Systemintegration sowie den durchgeführten Tests. Den Abschluss bildet eine Zusammenfassung der Ergebnisse sowie ein Ausblick auf die zukünftige Weiterentwicklungen.
